...
const Footer = () => {
  ...
  return (
    <footer className="bg-tutorly-primary text-white py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="mt-3 text-sm text-gray-300">
              Connecting students with qualified tutors through our AI-driven platform.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/tutors" className="text-gray-300 hover:text-white">Find Tutors</Link>
              </li>
              <li>
                <Link to="/register/tutor" className="text-gray-300 hover:text-white">Become a Tutor</Link>
              </li>
              <li>
                <Link to="/register/student" className="text-gray-300 hover:text-white">Register as Student</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/ask-question" className="text-gray-300 hover:text-white">Ask a Question</Link>
              </li>
            </ul>
          </div>
